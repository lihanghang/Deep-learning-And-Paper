...
audio_path= r'./dataSets/VCTK-Corpus/wav48'                                          
# utterance dataset
# clean_path = r'../speaker_vertification/clean_testset_wav'  # clean dataset
# noisy_path = r'../speaker_vertification/noisy_testset_wav'  # noisy dataset
